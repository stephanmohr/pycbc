...
from pycbc.distributions.spins import UniformComponentMassesChiPChiEff, \
...
distribs = {
    ...
    UniformComponentMassesChiPChiEff.name : UniformComponentMassesChiPChiEff,
    UniformQMChiPChiEff.name : UniformQMChiPChiEff
}
